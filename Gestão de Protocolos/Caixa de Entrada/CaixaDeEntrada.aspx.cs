...
namespace Gestão_de_Protocolos.Caixa_de_Entrada
{
    public partial class CaixaDeEntrada : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            connection.Open();
            var comando = new MySqlCommand($@"SELECT matricula_remetente,matricula_destinatario,assunto,mensagem,anexo,hora FROM envio WHERE `matricula_destinatario`= " + 3 /*Session["usuariologado"].ToString()*/, connection);
