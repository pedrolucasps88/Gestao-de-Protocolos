            ...
            if (!IsPostBack)
            {
                ...
                for (int i = 0; i < arquivos.Length; i++)
                {
                    ...
                    if (Path.GetExtension(nomeArquivo) == ".png")
                    {
                        ...
                        docpadro.InnerHtml += "<br/> <a href='../DocumentosPadroes/Documentos/" + setorsele + "/" + nomeArquivo.Replace(".png", ".pdf") + "' target='_blank' ><img src='../DocumentosPadroes/Thumbs/" + nomeArquivo + "'style='width: 200px; height: 250px;'/> </a><br/> ";
                    }
                }
            }
        }
