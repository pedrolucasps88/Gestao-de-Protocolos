    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 99%; height: 400px; margin-top: 5%; margin-left: 2%; background-color: transparent">
            ...
            <ul style="color: white">
                ...
                <li>Gerenciamento de arquivos em nuvem</li>
                <li>Acesso seguro com criptografia de ponta a ponta</li>
                <li>Compatibilidade com diversos tipos de arquivos</li>
        ...
        <div style="width: 100%; margin-top: -10%; height: 400px; background-color: white;">
            ...
            <br />
            <p style="margin-left: 40%">Garanta a segurança dos seus arquivos durante todo o processo de envio, recebimento, assinatura e controle com a nossa solução automatizada! Simplifique seus processos e tenha a tranquilidade de que seus dados estarão sempre protegidos.</p>
        </div>
        ...
        <div style="width: 100%; margin-top: 28%; height: 557px; background-color: white;">
            ...
            <br />
            <p style="margin-left: 5%">Entendemos que cada empresa possui suas particularidades e processos únicos de troca de informações e documentos. Por isso, oferecemos um estudo personalizado para identificar suas necessidades e oportunidades de melhoria. Nossa solução é implementada de forma estratégica, visando maximizar seu desempenho e automatizar seu processo protocolar. Otimize sua empresa agora mesmo com nossa solução sob medida! </p>
            <div class="row">
                <div style="margin-left: 5%; margin-top: 0.5%; width: 300px; height: 400px; position: absolute; border-radius: 10px; z-index: 1; background-image: radial-gradient(circle, #353639, #292a2d, #1e1e21, #131315, #010104);">
                ...
                <div style="margin-left: 39.9%; margin-top: 0.5%; width: 300px; height: 400px; position: absolute; border-radius: 10px; z-index: 1; background-image: radial-gradient(circle, #353639, #292a2d, #1e1e21, #131315, #010104);">
                ...
                <div style="margin-left: 75.2%; margin-top: 0.5%; width: 300px; height: 400px; position: absolute; border-radius: 10px; z-index: 1; background-image: radial-gradient(circle, #353639, #292a2d, #1e1e21, #131315, #010104);">
                ...
                <asp:Image ImageUrl="~/estudodiri.jpg" runat="server" Style="margin-left: 5%; margin-top: 0.5%; width: 300px; height: 250px; z-index: 3;" />
                <asp:Image ImageUrl="~/Implementação.jpg" runat="server" Style="margin-left: 12.5%; margin-top: 0.5%; width: 300px; height: 250px; z-index: 3;" />
                <asp:Image ImageUrl="~/desempenho.jpg" runat="server" Style="margin-left: 12.5%; margin-top: 0.5%; width: 300px; height: 250px; z-index: 3;" />
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <h6>SOBRE</h6>
                        <p class="text-justify">O <i>Gestão de Protocolos</i> É um sistema que faz com que os protocolos sejam enviados todos por meio de um servidor, ao invés de ter que ficar entregando de mão em mão pessoalmente, onde o destinatário poderá assinar tudo online sem precisar imprimir ou usar qualquer tipo de papel.</p>
                    </div>

                    <div class="col-xs-6 col-md-3">
                        <h6>Categories</h6>
                        <ul class="footer-links">
                            <li><a href="https://github.com/pedrolucasps88/Gestao-de-Protocolos">windows</a></li>
                            <li><a href="https://github.com/pedrolucasps88/Gestao-de-Protocolos">linux</a></li>
                            <li><a href="https://github.com/pedrolucasps88/Gestao-de-Protocolos">ubuntu</a></li>
                    ...
                    <div class="col-xs-6 col-md-3">
                        <h6>Quick Links</h6>
                        <ul class="footer-links">
                            <li><a href="https://github.com/pedrolucasps88/Gestao-de-Protocolos">Sobre nós</a></li>
                            <li><a href="https://github.com/pedrolucasps88/Gestao-de-Protocolos">Contate nos</a></li>
                            <li><a href="https://github.com/pedrolucasps88/Gestao-de-Protocolos">Contribue</a></li>
                            <li><a href="https://github.com/pedrolucasps88/Gestao-de-Protocolos">Politica de privacidade</a></li>
